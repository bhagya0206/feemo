...
const songs = [
    ...
    {
      id: '3',
      songName: 'On & On <br><div class="subtitle">Cartoon ft. Daniel Levi</div>',
      poster: 'img/3.jpg'
    },
    {
      id: '4',
    ...
    },
    {
      ...
      {
        id: '11',
        songName: 'Lagdi Lahore Di <br><div class="subtitle">Street Dancer 30</div>',
        poster: 'img/11.jpg'
      },
      {
        id: '12',
      ...
      {
        id: '20',
        songName: 'Dunny 82% <br><div class="subtitle">Ap Dhillon, Gurinder Gill, Shinda Kahlon</div>',
        poster: 'img/20.jpg'
      }
  ]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
  e.addEventListener('click', (el) => {
      ...
      if (music.src.includes(`audio/${clickedIndex}.mp3`)) {
